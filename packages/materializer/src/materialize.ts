...
import type { SpaceManifest, Sha256Integrity, SpaceKey } from "@agent-spaces/core";
...
import { writePluginJson, generatePluginJson } from "./plugin-json.js";
import { linkComponents, getAvailableComponents } from "./link-components.js";
import { validateHooks, ensureHooksExecutable } from "./hooks-builder.js";
import { composeMcpFromSpaces, type McpConfig } from "./mcp-composer.js";
...
export async function materializeSpace(
	...
	try {
		...
		const linked = await linkComponents(input.snapshotPath, pluginPath);
