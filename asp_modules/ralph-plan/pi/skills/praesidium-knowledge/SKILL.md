...
### control-plane (`~/praesidium/core/control-plane`)
...
### spaces (`~/praesidium/agents/spaces`)

Composable expertise modules. Bun/TypeScript monorepo with semver registry.

### metaskills (`~/praesidium/agents/metaskills`)

Meta-cognitive skills for agents.

### agentchat (`~/praesidium/agents/agentchat`)

Chat interface for agent interactions.

## User-Facing Tools

### taskboard (`~/praesidium/users/taskboard`)

Web UI for wrkq task management.

## Infrastructure Tools

### ghostmux (`~/praesidium/tools/ghostmux`)

Terminal orchestration CLI.

### scriptable-ghostty (`~/praesidium/tools/scriptable-ghostty`)

Ghostty fork with scripting support.

### stackctl (`~/praesidium/tools/stackctl`)
